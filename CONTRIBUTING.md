...
issue](https://github.com/cisagov/ansible-role-admiral/issues) in
...
request](https://github.com/cisagov/ansible-role-admiral/pulls), you
...
```console
cd ansible-role-admiral
pyenv virtualenv <python_version_to_use> ansible-role-admiral
pyenv local ansible-role-admiral
